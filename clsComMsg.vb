...
Public Class clsComMsg
                                                                                                                                ...
                                                                                                                                Public Sub ErrorUpdated()
                                                                                                                                    ...
                                                                                                                                    ErrorCustom("このデータは他ユーザにより、追加・削除もしくは更新されました。" & vbCrLf &
                                                                                                                                                "入力された内容は保存されませんでした。" & vbCrLf & vbCrLf &
                                                                                                                                ...
                                                                                                                                Public Sub ErrorTimeOut(Optional ByVal strMsg As String = "")
                                                                                                                                    ...
                                                                                                                                    Dim wstrMsg As String
                                                                                                                                    wstrMsg = strMsg & vbCrLf & vbCrLf &
                                                                                                                                              "情報の取得(SELECT)および操作(INSERT/UPDATE/DELETE)の制限時間を超えました。" & vbCrLf &
                                                                                                                                              "他のクライアントで更新中の可能性があります。" & vbCrLf & vbCrLf &
                                                                                                                                              "確認してください。"
                                                                                                                                    ErrorCustom(wstrMsg)
                                                                                                                                ...
                                                                                                                                Public Sub ErrorSystem(ByVal objErr As ErrObject, Optional ByVal strMsg As String = "")
                                                                                                                                    ...
                                                                                                                                    If objErr.Number = -2147217843 Then
                                                                                                                                        Me.ErrorCustom("ユーザ：" & strMsg & vbCrLf &
                                                                                                                                                        "この利用者ではログインできません。" & vbCrLf &
                                                                                                                                                        "データベースに対する処理がされていない可能性もあります。環境を見直してください。" & vbCrLf &
                                                                                                                                                        "処理を中止します。")
                                                                                                                                        objErr.Clear()
                                                                                                                                        Exit Sub
                                                                                                                                    End If
